    ...
    <main className="bg-transparent text-white font-sans">
      ...
      <nav className="flex justify-center items-center px-10 py-5 border-b border-gray-800">
        ...
        <ul className="hidden md:flex space-x-8 text-sm">
          ...
          <li><Link href="/browse_turfs" className="hover:text-cyan-400">Turfs</Link></li>
          <li onClick={handleTurfOwnerClick} className="hover:text-cyan-400 cursor-pointer">Turf Owner</li>
